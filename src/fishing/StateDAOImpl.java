...
//	@Override
//	public State printId(int num) {
//		System.out.println("printId DAOImpl success");
//		query = "select nickname, fishrod, money from userlist where num = ?;";
//		try {
//			pst = conn.prepareStatement(query);
//			pst.setInt(1, num);
//			ResultSet rs = pst.executeQuery();
//			if(rs.next()) {
//				State s = new State(rs.getString("nickname"), rs.getString("fishrod"), rs.getInt("money"));
//				return s;
//			}
